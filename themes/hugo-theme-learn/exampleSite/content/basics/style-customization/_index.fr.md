...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/public/images/` et nommez le `favicon.png`
...
![Variante rouge](/en/basics/style-customization/public/images/red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/public/images/blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/public/images/green-variant.png?width=60pc)
